...
import math
import numpy as np
from common.memory import RealCounterFactualReplayBuffer as Buffer
from common.model import TEA_state
...
class DMIR:
    ...
    def update(self, available_items, all_nbr, all_nbr_iid, all_nbr_iid_rate, args):
        ...
        ava_items_batch = available_items[user_batch].to(self.device)
